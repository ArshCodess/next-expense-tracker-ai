...
const AddRecord = () => {
  ...
  const [amount, setAmount] = useState('10'); // Default value for expense amount as string
  ...
  const clientAction = async (formData: FormData) => {
    ...
    formData.set('amount', parseFloat(amount || '0').toString()); // Add the amount value to the form data
